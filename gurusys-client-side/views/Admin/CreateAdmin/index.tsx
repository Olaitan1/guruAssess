...
const createAdminFormValidationSchema: Object = Yup.object().shape({
    userName: Yup.string()
        ...
        <section className="flex flex-col min-h-screen w-full p-2">
            ...
            <>
                <Formik
                    ...
                    validationSchema={createAdminFormValidationSchema}
                ...
                >
                    {({ errors, touched }) => (
                        <Form className="flex items-center justify-center min-h-full lg:min-h-[70vh] w-full">
